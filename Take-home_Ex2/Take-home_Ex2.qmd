...
+========+=============================================================================================================================================================================================================================================================================================================================+=============================================+
| 🌟     | The author chose the areas in purpose instead of randomly. That means the author is showing the patterns of population structure with a clear objective.                                                                                                                                                                    | ![](images/paste-4B4889B2.png)              |
+--------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------+
| 🌟     | The title shows clearly the chart type, which is *Demographic structure.*                                                                                                                                                                                                                                                   | ![](images/paste-AE5ED1DB.png)              |
+--------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------+
...
+--------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------+
| ❎     | The range of each age group is normally 5, such as 0-4, 5-9 and so on. Otherwise, the shape of the population structure may miss some important information. The range of group in the chart above is 10 years. Maybe better to switch to 5 years as the same as the raw data.                                              | ![](images/paste-983B8D0A.png)              |
+--------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------+
...
+--------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------+
| ❎     | However, the range of x-axis is too large so that the shape is contacted.                                                                                                                                                                                                           | ![](images/paste-1A5FAEEB.png) |
+--------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------+
| ❎     | There is a ***Column*** on top of the chart, and as well ***Female population*** and ***Male population***as x-label at the bottom of the chart. So it is a little confusing.                                                                                                       | ![](images/paste-B9130EAD.png) |
|        |                                                                                                                                                                                                                                                                                     |                                |
...
+--------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------+
| ❎     | The y-label retains the column name, *AG,* of the raw data frame, which is the short of age but no explanation here.                                                                                                                                                                | ![](images/paste-869A1352.png) |
+--------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------+
...
From the screenshot above, we see it is important to clean our data table.
...
In accordance to the author's intention, we need to find out the **top 9** population planning areas. Code chunk below will help us achieve this.

```{r}
tail(
  ppl%>%
  group_by(PA)%>%
    summarise("Population"=sum(PP))%>%
  arrange(Population,FALSE),
  9)
```
...
ppl%>%
  ...
  mutate(PP = ifelse(SX == "Males", PP*(-1), PP*1))%>%
  ...
  geom_text(stat="identity", 
      ...
      round(..PP../sum(..PP..)*100,
            1), "%")),
      vjust=-1) +
    labs(title = "Demographic Pyramid of Top 9 Population Planning Areas in SG (June 2023)",
