...
+========+=============================================================================================================================================================================================================================================================================================================================================+==============================================================================+
| 🌟     | The author chose the areas in purpose instead of randomly. That means the author is showing the patterns of population structure with a clear objective.                                                                                                                                                                                    | ![](images/paste-4B4889B2.png){width="1207"}                                 |
+--------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------+
| 🌟     | The title shows clearly the chart type, which is *Demographic structure.*                                                                                                                                                                                                                                                                   | ![](images/paste-AE5ED1DB.png){width="1207" height="70"}                     |
+--------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------+
| 🌟     | The title shows the time of the data collection, which is June 2022.                                                                                                                                                                                                                                                                        | ![](images/paste-EF0764C7.png)                                               |
+--------+---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+------------------------------------------------------------------------------+
...
+--------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------+
| ❎     | However, the **range** of y-axis is too **large** so that the shape is contacted.                                                                                                                                                                                                   | ![](images/paste-1A5FAEEB.png){width="1207"}                |
+--------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------+
| ❎     | There is a ***Column*** on top of the chart, and ***Female population*** and ***Male population*** as x-label at the bottom of the chart. So it is a little confusing.                                                                                                              | ![](images/paste-B9130EAD.png)                              |
|        |                                                                                                                                                                                                                                                                                     |                                                             |
|        |                                                                                                                                                                                                                                                                                     | ![](images/paste-1A5FAEEB.png)                              |
+--------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------+
| ❎     | For each small chart, the author puts the **name** of the planning area **beside the bar of the age group with the** **most population**. There may be some information the author intends to deliver like the age group with the most population, but it appears not very obvious. | ![](images/paste-D4DAE5C3.png)                              |
+--------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------+
| ❎     | The **x-label** retains the column name, ***AG**,* of the raw data frame, which is the short of age but **no explanation** here.                                                                                                                                                    | ![](images/paste-869A1352.png)                              |
+--------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+-------------------------------------------------------------+
...
+--------+------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------+
| ❎     | The **aliases** of the y-axis are a little tedious, which contains ***number, string*** and ***special character.*** It is better to simplify the aliases. | ![](images/paste-983B8D0A.png) |
+--------+------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------+
| ❎     | There are **column numbers** for the whole chart, which is tedious.                                                                                        | ![](images/paste-7E4C5FBB.png) |
+--------+------------------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------+
...
Then we need to create a new column which shows percentage of population belonging to each age group for male and female in each planning area. First, we need to use codes below to compute the sum of population of each gender in each planning area.
...
We can create now the new column named *PCT* using code chunk below and have a look at the new data table.
...
We see that we have new column named *PCT* in the most right of the data table, there are percentage of population from each age group of female or male in each planning area.
...
As shown in chart above, **Bedok, Tampines, Jurong West, Sengkang, Woodlands, Hougang, Yishun, Choa Chu Kang** and **Punggol** are the top 9 planning areas.

#### 5.6.2 Recoding of column AG

In order to better sort the y-axis, we recode the values in column *AG* as the cutting years, 0, 5, 10, ..., 90 using below codes.
...
#### 5.6.3 Plotting population structure pyramid

##### 5.6.3.1 Review and improvement of the issues
...
-   Recode the age group **aliases** to the **cut** of years.
...
p<-pct%>%
  ...
  theme(axis.text.x=element_text(angle=0))+
    xlab("Age Group")+
    ylab("No. of \n Population")+
    ggtitle("Demographic structure pyramid of top 9 population planning areas in SG (June 2023)")+
    theme_gray()+
